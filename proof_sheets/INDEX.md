...
## Test Coverage Ratings

Each sheet carries a **Test Coverage** rating — added March 15, 2026. This is the honest answer to "how thoroughly is this tested?":

| Rating | Meaning |
|---|---|
| **VERIFIED** | Behavioral tests exercise this claim across multiple scenarios including error paths |
| **SMOKE** | Behavioral tests confirm primary path only; edge cases and error conditions not fully covered |
| **CODE-ONLY** | Claim backed by source inspection or configuration grep; no behavioral test verifies this in isolation |
...
| [TB-PROOF-026](TB-PROOF-026_concurrent_requests.md) | 50 Concurrent Requests Handled | INFRA |
...
| Sheet | Claim | Tests | Test Coverage |
|---|---|---|---|
